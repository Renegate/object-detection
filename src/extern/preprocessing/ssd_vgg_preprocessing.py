...
import src.extern.tf_extended as tfe

from tensorflow.python.ops import control_flow_ops

from src.extern.preprocessing import tf_image
from src.extern.nets import ssd_common
...
RESIZE_NONE = 'NONE'
RESIZE_CENTRAL_CROP = 'CENTRAL_CROP'
RESIZE_PAD_AND_RESIZE = 'PAD_AND_RESIZE'
RESIZE_WARP_RESIZE = 'WARP_RESIZE'
...
def preprocess_for_eval(image, labels, bboxes,
                        ...
                        difficults=None, resize=RESIZE_WARP_RESIZE,
                        scope='ssd_preprocessing_train'):
    ...
    with tf.name_scope(scope):
        ...
        if resize == RESIZE_NONE:
            ...
            image, bboxes = tf_image.resize_image_bboxes_with_crop_or_pad(
                image, bboxes, out_shape[0], out_shape[1])
        elif resize == RESIZE_WARP_RESIZE:
